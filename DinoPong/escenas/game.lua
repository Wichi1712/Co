...
--local background = display.newImageRect( "Assets/fondo.png",650,810)--, 360, 570 )
--background.x = display.contentCenterX
--background.y = display.contentCenterY

local turtleBall = display.newImageRect( "Assets/spr_turtleBall_0.png", 112, 112 )
turtleBall.x = display.contentCenterX
turtleBall.y = display.contentCenterY
turtleBall.alpha = 0.8 --transparencia

local player = display.newImageRect("Assets/spr_rocky_0.png", 64,64)
player.x = display.contentCenterX
player.y = 450

local dino = display.newImage("Assets/dino.png")
dino.x = display.contentCenterX
--dino.y+=1

local tapText = display.newText( tapCount, display.contentCenterX, 20, native.systemFont, 40 )
tapText:setFillColor( 0, 0, 0 )--le damos color al texto



physics.addBody( player, "static" )
physics.addBody( turtleBall, "dynamic", { radius=50, bounce=0.3 } )


local function pushBall()
	turtleBall:applyLinearImpulse( 0, -0.75, turtleBall.x, turtleBall.y )
	tapCount = tapCount + 1
...
function scene:create(event)
  ...
  -- Load the background
  local fondo = display.newImage(backGroup,"Assets/fondo.png")
  ...
  -- Display lives and score
	livesText = display.newText( uiGroup, "Lives: " .. lives, 50, 80, native.systemFont, 20 )
	scoreText = display.newText( uiGroup, "Score: " .. score, 150, 80, native.systemFont, 20 )
